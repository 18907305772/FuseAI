        ...
        if self.sep_style == SeparatorStyle.ADD_COLON_SINGLE:
            ...
            for i, (role, message) in enumerate(self.messages):
                if message:
                    ...
                    ret += role + ":"
            return ret
        elif self.sep_style == SeparatorStyle.OPEN_CHAT:
            ret = ""
            for i, (role, message) in enumerate(self.messages):
                if message:
                    ...
                    ret += role + ":"
            return ret
        elif self.sep_style == SeparatorStyle.PRETRAIN:
            seps = [self.sep, self.sep2]
            ret = ""
            for i, (role, message) in enumerate(self.messages):
                if message:
...
register_conv_template(
    Conversation(
        ...
        sep_style=SeparatorStyle.OPEN_CHAT,
        sep="",
        sep2="<|end_of_turn|>",
    )
)
...
register_conv_template(
    Conversation(
        ...
        system_message="",
        roles=("", ""),
        sep_style=SeparatorStyle.PRETRAIN,
        sep="",
        sep2="</s>",
    )
)
