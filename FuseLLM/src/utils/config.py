...
class DataArguments:
    ...
    max_train_samples: Optional[int] = field(
        default=None,
        metadata={"help": "The max train samples."}
    )
    max_eval_samples: Optional[int] = field(
        default=None,
        metadata={"help": "The max eval samples."}
    )
    max_predict_samples: Optional[int] = field(
        default=None,
        metadata={"help": "The max predict samples."}
    )
...
class TrainingArguments(Seq2SeqTrainingArguments):
    ...
    training_mode: Optional[str] = field(
        default="full",
        metadata={"help": "The training mode: full or qlora."}
    )
    ...
    optim: str = field(
        default='adamw_torch',
        metadata={"help": 'adamw_torch or paged_adamw_32bit.'}
    )
    # qlora args
    adam8bit: bool = field(
        default=False,
    ...
    distill_greater_as_gt_type: Optional[str] = field(
        default="hard",
        metadata={"help": "hard or hard_and_decay or soft."}
    )
